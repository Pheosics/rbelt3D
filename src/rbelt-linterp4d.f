...
c of B0 specified in rbelt-const.inc.
      ...
      real*8 w1,w1m,w2,w2m,w3,w3m,w4,w4m,w1m2m
      real*8 w12m,w12,w1m2,w1m2m3m,w12m3m,w123m
      real*8 w1m23m,w1m2m3,w123,w1m23,w12m3
      real*8 ww01,ww02,ww03,ww04,ww05,ww06,ww07,ww08
      real*8 ww09,ww10,ww11,ww12,ww13,ww14,ww15,ww16
      real*8 w2m3m4m,w23m4m,w2m34m,w234m,w2m3m4,w23m4
      real*8 w1m3m4m,w13m4m,w13m4,w1m24m,w124m,w12m4,w1m2m4
      real*8 w2m34,w234,w1m34m,w134m,w1m3m4,w134
      real*8 w1m34,w1m2m4m,w12m4m,w1m24,w124
      real*8 r,r2,bfac1
      real*8 pa,lshell,energy,pangle_lorentz
      real*8 rho,rho2,bs1,bs2
      parameter(bs1=10*ffactor*ntg,bs2=8)
...
*     &   (t.lt.tgr(1)).or.(t.ge.tgr(nstep))) then
*         status=1
*         print *
...
*         if (t.ge.tgr(nstep)) print*,'t >= tgr(nstep)'
*         return
*      endif
...
!        open(112,file="test.dat")
!        pa = pangle_lorentz(y,t)
!        lshell = dsqrt(y(1)**2+y(2)**2+y(3)**2)/
!     &        ((y(1)**2+y(2)**2)/(y(1)**2+y(2)**2+y(3)**2))
!        energy = (dsqrt(1+y(4)**2+y(5)**2+y(6)**2)-1)*wrest
!        if ((ix.ne.ixs).or.(iy.ne.iys).or.(iz.ne.izs)) then
!         open(112,file="test.txt",status="old",access="append")
!         write(112,*) t/tfactor
!         write(112,*) ix,iy,iz
!         write(112,*) ixs,iys,izs
!         write(112,*) pa*raddeg,lshell,energy
!         write(112,*) pas*raddeg,lshells,energys
!         close(112)
!         print *, t/tfactor
!         print *, ix, iy, iz
!         print *, ixs, iys, izs
!         print *, pa*raddeg,lshell,energy
!         print *, pas*raddeg,lshells,energys        
!        endif
...
!        energys = energy
      ...
      w1=dabs(y(1)-xgr(ix))/dx
      w1m=1.-w1
      w2=dabs(y(2)-ygr(iy))/dy
      w2m=1.-w2
      w3=dabs(y(3)-zgr(iz))/dz
      w3m=1.-w3
      w4=dabs(t-tgr(it))/dt
      w4m=1.-w4
...
c approximation for purtabation fileds.
      ...
      real*8 w2m34,w234,w1m34m,w134m,w1m3m4,w134
      real*8 w1m34,w1m2m4m,w12m4m,w1m24,w124
      real*8 r,r2,bfac1,bfac2
      real*8 bxm,bym,bzm,bxp,byp,bzp,bm,bp
      real*8 rho,rho2,bs1,bs2
      parameter(bs1=10*ffactor*ntg,bs2=8)
*      print *
